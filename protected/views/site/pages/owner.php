        ...
        <h1>About us <small> everything you need to know about Handistro</small></h1>
        </div>
	<div class="row-fluid">
     <div class="span9">
        ...
        <div class="span4">
            ...
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/handiko3.jpg" width="260" height="180" alt="Me" />
            <h3>
            Handiko R.P <br /><small>Web Desainer</small>
            </h3>
            <p>Merancang web Handistro serta mengembangkan web.
            </p>
            <br /><br />
          ...
          <div class="span4">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/handiko1.jpg" width="260" height="180" />
            <h3>
            Handiko R.P <br /><small>CEO</small>
            </h3>
            <p>Pemilik Handistro
            </p>
            <br /><br /><br />
          ...
          <div class="span4">
            ...
            <div class="colored_banner thumb-content-dark">
            <img src="<?php echo Yii::app()->theme->baseUrl;?>/img/handiko2.jpg" width="260" height="180" />
            <h3>
            Handiko R.P <br /><small>Sales</small>
            </h3>
            <p>Pengiklan
            </p>
            <br /><br /><br />
     ...
     <div class="span3">
      ...
      <h3 class="header">Handistro,
        	<span class="header-line"></span> 
      </h3>
      <div class="well">
      <p>Keuntungan jika order di Handistro</p>
      <ul class="list-icon">
        <li>1. Terpercaya</li>
        <li>2. Mudah dan Cepat</li>
        <li>3. Bebas biaya ongkos kirim</li>
          </ul>
      <p>
